            ...
            <div className="flex items-center justify-center w-[50%] max-[600px]:w-full">
                <div>
                  ...
                  <form action="" className="flex flex-col">
                      ...
                      <input className="border-[1px] border-[#70686842] rounded-[4px] bg-[#71717d15] px-[2%] py-1 mb-[20px]" type="email" id="email" placeholder="eddie@gmail.com"/>
                      <label className="text-[14px] font-[600] mb-1" htmlFor="senha">Senha</label>
                      <input className="border-[1px] border-[#685d5d4b] rounded-[4px] bg-[#71717d15] px-[2%] py-1 mb-[5px]" type="password" id="senha" placeholder="039939393"/>
