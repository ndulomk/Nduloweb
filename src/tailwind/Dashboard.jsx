        ...
        {/* bg-[radial-gradient #193350,#0f172a)] */}
          <nav className="flex px-[2%] py-[10px] justify-between items-center border-b-[1px] border-[#54565e26]">
              <div className="flex items-center justify-center">
                  ...
                  <button className="bg-[#142a41] text-[#38bdf8] rounded-[15px] py-1 px-2 font-bold text-[14px]"><span>Introducing Catalyst - Amodern application UI kit for React</span></button>
              </div>
              <div className="flex">
