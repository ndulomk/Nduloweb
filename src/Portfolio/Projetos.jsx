                    ...
                    <div key={index} className="mb-[40px] max-[330px]:mb-[80px]">
                      ...
                      <div className="pt-2">
                        ...
                        <div className="flex gap-[20px] mt-[20px] ">
                          <button onClick={sendto} className={boolean ? "px-[5px] py-1 text-white bg-[#4b4edf] rounded-[4px] font-[600] hover:bg-[#26276c] transition-[0.5s] w-full":"w-full px-[5px] py-1 text-black bg-[#97edaa] rounded-[4px] font-[600] hover:bg-[#466a4e] transition-[0.5s] max-[870px]:px-[10%] max-[750px]:px-[7%] max-[620px]:px-[3%] max-[520px]:py-[1%]"}>Access Project</button>
